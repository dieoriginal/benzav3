...
const LibraryPage: React.FC = () => {
    ...
    Wishlist: [
      {
        ...
        genre: "Typography",
        cover:
          "https://en.wikipedia.org/wiki/File:The_Art_of_War_Running_Press.jpg",
...

      {
        ...
        whyRead:
          "Understand Baldwin IV and the Crusader Kingdom of Jerusalem Bravery and leadership skills on battlefields.",
      },
...

      {
        ...
        cover: "https://example.com/cover4.jpg",
        buyLink:
          "https://www.amazon.it/Champ-Fleury-Geofroy-Tory/dp/0854092099?ref_=ast_author_dp",
        pdfLink:
          "https://www.amazon.it/Champ-Fleury-Geofroy-Tory/dp/1891788868?ref_=ast_author_dp",
        year: 1971,
        description: "History of the Crusader Kingdom of Jerusalem.",
        whyRead:
          "Understand Baldwin IV and the Crusader Kingdom of Jerusalem Bravery and leadership skills on battlefields.",
      ...
      {
        title:
          "Champ Fleury Auquel Est Contenu L'Art Et Science De La Deue Et Vraye Proportio Des Lettres Attiques Quo Dit Autremet Lettres Antiques",
        author: "Geofroy Tory",
        genre: "Typography",
        cover: "https://example.com/cover4.jpg",
        buyLink:
      ...
      {
        title:
          "The Jewish Enemy: Nazi Propaganda during World War II and the Holocaust Illustrated Edition",
        author: "Jeffrey Herf",
        genre: "History",
        ...
        year: 2018,
        description:
          "An analysis of Nazi propaganda and its impact during WWII.",
        whyRead:
          "Important for understanding the role of propaganda in history.",
      },
      {
        title:
        ...
        year: 2014,
        description:
          "Explores the relationship between Judaism and Christianity.",
        whyRead:
          "Provides insights into the historical context of both religions.",
      },
      {
      ...
      },
      {
        ...
        whyRead:
          "Essential for understanding the religious transformations in Europe.",
      },
      {
        ...
        whyRead:
          "Provides insights into the development of Christianity over millennia.",
      },
      {
        ...
        whyRead:
          "Provides insights into the transition from antiquity to the medieval world.",
      },
      {
        ...
        year: 2008,
        description:
          "A concise overview of the early medieval period in Europe.",
        whyRead:
          "Essential for understanding the foundations of medieval Europe.",
      },
      {
        ...
        buyLink:
          "https://www.amazon.it/Byzantium-Surprising-Life-Medieval-Empire/dp/0691143692",
      ...
      },
      {
        ...
        year: 2009,
        description:
          "Examines the strategies of Byzantium in preserving its legacy.",
        whyRead:
          "Offers insights into the political and military tactics of the empire.",
      },
      {
        ...
        whyRead:
          "Essential for understanding the formation of medieval Europe.",
      },
      {
        title:
        ...
        whyRead:
          "Provides a comprehensive view of the transition from empire to new political entities.",
      },
      {
        title:
      ...
      },
      {
        ...
        whyRead:
          "Essential for understanding the cultural evolution post-Rome.",
      },
      {
      ...
      },
      {
        ...
        year: 2013,
        description:
          "An exploration of the impact of the printing press on European society.",
        whyRead:
          "Essential for understanding the transition to modernity in the West.",
      },
      {
        ...
        year: 2019,
        description:
          "This book provides a concise, linear narrative of human history from prehistory to modern times. It covers major transitions, such as the development of agriculture, the rise of ancient civilizations, and the Middle Ages, with clear explanations and minimal fluff.",
        whyRead:
          "Essential for understanding the broad strokes of human history.",
      },
      {
        ...
        year: 2011,
        description:
          "While not strictly linear, Harari's book covers the evolution of human societies, including key transitions like the Agricultural Revolution and the rise of empires, with engaging insights into their significance.",
        whyRead:
          "Offers a thought-provoking perspective on the development of human societies.",
      },
      {
        title:
        ...
        year: 1998,
        description:
          "A collection of essays reflecting on the contributions of Aldus Manutius to Renaissance culture.",
        whyRead:
          "Provides insights into the impact of printing and humanism during the Renaissance.",
      },
      {
        ...
        year: 1997,
        description:
          "Explains how geography and environment influenced the development of societies, starting from early human origins in Africa to global power imbalances.",
      ...
      },
      {
        ...
        year: 2011,
        description:
          "Offers a sweeping history of Homo sapiens, beginning in Africa and following migrations, societal evolutions, and the rise of modern institutions.",
        whyRead:
          "Essential for understanding the evolution of human societies.",
      },
      {
        ...
        year: 2003,
        description:
          "Chronicles the interconnected history of human societies, starting with early human migrations from Africa, emphasizing the importance of networks.",
      ...
      },
      {
        ...
        year: 2003,
        description:
          "Explores genetic and archaeological evidence tracing human migration from Africa to populate the world.",
      ...
      },
      {
        ...
        year: 2011,
        description:
          "Focuses on Africa’s central role in world history, from human origins to the continent's interactions with global powers.",
        whyRead:
          "Essential for understanding Africa's impact on global history.",
      },
    ],
    Reading: [
      {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900">
      <h1 className="text-4xl font-extrabold text-center mb-8 text-gray-900 dark:text-gray-100 mt-10">
        Library
      </h1>
      {Object.entries(categories).map(([category, books]) => (
        <div
          key={category}
          className="w-full p-6 bg-white dark:bg-gray-800 shadow-lg rounded-lg mb-6 relative"
        >
          <div
            className="absolute inset-0 bg-gray-200 dark:bg-gray-700 rounded-lg opacity-50"
            style={{ margin: "10px" }}
          ></div>
          <h2 className="text-3xl font-extrabold text-gray-900 dark:text-gray-100 mb-4 relative z-10">
            {category}
          </h2>
          <table className="min-w-full border-collapse border border-gray-300 dark:border-gray-600 text-center relative z-10">
            <thead>
              <tr className="bg-gray-200 dark:bg-gray-700">
                <th className="border border-gray-300 dark:border-gray-600 p-2 text-gray-900 dark:text-gray-100">
                  Cover
                </th>
                <th className="border border-gray-300 dark:border-gray-600 p-2 text-gray-900 dark:text-gray-100">
                  Title
            ...
            <tbody>
              {books.map((book, index) => (
                <tr key={index}>
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 p-2 text-gray-900 dark:text-gray-100 font-extrabold">
                    {book.title}
                  </td>
                  <td className="border border-gray-300 dark:border-gray-600 p-2 text-gray-900 dark:text-gray-100">
                    {book.author}
