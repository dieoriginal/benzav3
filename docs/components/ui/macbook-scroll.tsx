...
export const Lid = ({
  ...
  return (
    <div style={{ perspective: '800px' }} className="relative">
      ...
      >
        {/* Content inside the Lid component */}
      </div>
      <motion.div
        style={{
          scaleX: scaleX,
      ...
      >
        ...
        <Image
          src="https://substackcdn.com/image/fetch/w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F27253e8e-2d70-41e0-99f1-f9e5a684f1a3_2918x1855.jpeg"
          alt="Cursor AI IDE"
          fill
          className="object-top h-40 inset-0 pb-7"
        />
      </motion.div>
    </div>
  );
...
export const SpeakerGrid = () => {
  return (
    <div
      ...
      style={{
        backgroundImage:
          "radial-gradient(circle, #000000 0.5px, transparent 0.5px)",
