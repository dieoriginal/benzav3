    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900">
      <div className="max-w-md p-8 bg-white dark:bg-gray-800 shadow-lg rounded-lg">
        <div className="flex justify-center mb-4">
          <img src="https://i1.sndcdn.com/avatars-HLLfDqBvQYg6UwW7-qROu8w-t500x500.jpg" alt="Yasmine Dicko" className="rounded-lg shadow-md" />
        </div>
        <h1 className="text-2xl font-bold text-center mb-4 text-gray-900 dark:text-gray-100">Yasmine Dicko</h1>
        <p className="text-center text-gray-700 dark:text-gray-300 mb-6">
          Everything I owe to Yasmine Dicko
        </p>
        <table className="min-w-full border-collapse border border-gray-300 dark:border-gray-600 text-center">
          ...
          <tbody>
            <tr>
              <td className="border border-gray-300 dark:border-gray-600 p-2 text-gray-900 dark:text-gray-100">Caução</td>
