        ...
        <div className='flex flex-row gap-4 flex-wrap'>
          ...
          <div className='flex flex-row gap-4 '>
            <div className="w-fit h-fit p-4 bg-white dark:bg-gray-800 shadow-lg rounded-lg">
              <h1 className="text-xl font-bold text-center mb-2 text-gray-900 dark:text-gray-100">1. &quot;The Regency Gentleman’s Wardrobe&quot; by Peter Davidson</h1>
              <p className="text-center text-gray-700 dark:text-gray-300 mb-4">
                Focus: Offers a comprehensive guide to the garments and accessories of the Regency period, with illustrations and detailed descriptions of tailcoats, waistcoats, cravats, and breeches.
                <br />
                Why It's Useful: It details the etiquette and craftsmanship of the time, making it an excellent reference for those recreating or studying Regency style.
              </p>
            </div>
            <div className="w-fit h-fit p-4 bg-white dark:bg-gray-800 shadow-lg rounded-lg">
              <h1 className="text-xl font-bold text-center mb-2 text-gray-900 dark:text-gray-100">7. &quot;Miss Lisa Brown's Guide to Dressing for a Regency Ball&quot;</h1>
              <p className="text-center text-gray-700 dark:text-gray-300 mb-4">
                Focus: A comprehensive guide on attire suitable for men's balls, detailing styles, fabrics, and accessories.
                <br />
                Why It's Useful: Provides insights into appropriate clothing choices for formal events, ensuring elegance and sophistication.
              </p>
              <div className="flex justify-center mb-4">
                <a href="https://cdrochester.org/flyers/MensBallClothing2008.pdf" className="text-blue-500 hover:underline">Read</a>
              </div>
            </div>
            <div className="w-fit h-fit p-4 bg-white dark:bg-gray-800 shadow-lg rounded-lg">
              <h1 className="text-xl font-bold text-center mb-2 text-gray-900 dark:text-gray-100">7. &quot;What to Wear to a Regency Ball by Sue Hanson&quot;</h1>
              <p className="text-center text-gray-700 dark:text-gray-300 mb-4">
                Focus: A comprehensive guide on attire suitable for men's balls, detailing styles, fabrics, and accessories.
                <br />
                Why It's Useful: Provides insights into appropriate clothing choices for formal events, ensuring elegance and sophistication.
              ...
              <div className="flex justify-center mb-4">
                <a href="http://www.centralillinoisecd.org/Files/RegencyCostumeClass.pdf" className="text-blue-500 hover:underline">Read</a>
              </div>
            </div>
          </div>

          <div className="w-fit h-fit p-4 bg-white dark:bg-gray-800 shadow-lg rounded-lg">
            <h1 className="text-xl font-bold text-center mb-2 text-gray-900 dark:text-gray-100">8. &quot;Fashion in the Regency Era&quot; by Daniel James Cole</h1>
            <p className="text-center text-gray-700 dark:text-gray-300 mb-4">
              Focus: A comprehensive exploration of fashion during the Regency period, featuring illustrations and detailed descriptions of clothing styles.
              <br />
              Why It's Useful: Provides valuable insights into the aesthetics and cultural significance of Regency fashion.
            </p>
            <div className="flex justify-center mb-4">
              <a href="https://www.uvm.edu/~hag/regency/00-all-costume-fashion-images/myresearch/Daniel%20James%20Cole.pdf" className="text-blue-500 hover:underline">Read</a>
            </div>
          </div>
          ...
          <div className='flex flex-row gap-4'>
            <div className="w-fit h-fit p-4 bg-white dark:bg-gray-800 shadow-lg rounded-lg">
              <h1 className="text-xl font-bold text-center mb-2 text-gray-900 dark:text-gray-100">2. &quot;Beau Brummell: The Ultimate Dandy&quot; by Ian Kelly</h1>
              <p className="text-center text-gray-700 dark:text-gray-300 mb-4">
                Focus: Chronicles the life and influence of Beau Brummell, who revolutionized men’s fashion in the Regency era.
                <br />
                Why It's Useful: Provides historical context and insight into how Brummell’s minimalist, tailored style set trends for the Regency gentleman.
              </p>
            </div>
            <div className="w-fit h-fit p-4 bg-white dark:bg-gray-800 shadow-lg rounded-lg">
              <h1 className="text-xl font-bold text-center mb-2 text-gray-900 dark:text-gray-100">3. &quot;Regency Fashion: Men's and Women's Clothing 1795-1820&quot; by Cassidy Percoco</h1>
              <p className="text-center text-gray-700 dark:text-gray-300 mb-4">
                Focus: Includes patterns, illustrations, and detailed analyses of both men’s and women’s clothing during the Regency period.
                <br />
                Why It's Useful: Highlights technical construction and materials, ideal for designers or history enthusiasts.
              </p>
            </div>
            <div className="w-fit h-fit p-4 bg-white dark:bg-gray-800 shadow-lg rounded-lg">
              <h1 className="text-xl font-bold text-center mb-2 text-gray-900 dark:text-gray-100">4. &quot;The Art of Tying the Cravat&quot; by H. Le Blanc</h1>
              <p className="text-center text-gray-700 dark:text-gray-300 mb-4">
                Focus: A historical guidebook from the Regency era itself, instructing men on various ways to tie cravats (a key element of Regency fashion).
                <br />
                Why It's Useful: Offers firsthand insight into the era’s emphasis on detail and sophistication in neckwear.
              </p>
              <div className="flex justify-center mb-4">
                <a href="https://ia800202.us.archive.org/24/items/arttyingcravat00unkngoog/arttyingcravat00unkngoog.pdf" className="text-blue-500 hover:underline">Read</a>
              </div>
            </div>
          </div>

          <div className="w-fit h-fit p-4 bg-white dark:bg-gray-800 shadow-lg rounded-lg">
            <h1 className="text-xl font-bold text-center mb-2 text-gray-900 dark:text-gray-100">5. &quot;Costume in Detail: 1730-1930&quot; by Nancy Bradfield</h1>
            <p className="text-center text-gray-700 dark:text-gray-300 mb-4">
              Focus: Features detailed sketches and descriptions of historical garments, including Regency-era menswear.
              <br />
              Why It's Useful: Ideal for studying construction details and specific fabric choices.
            </p>
          </div>
          <div className="w-fit h-fit p-4 bg-white dark:bg-gray-800 shadow-lg rounded-lg">
            <h1 className="text-xl font-bold text-center mb-2 text-gray-900 dark:text-gray-100">6. Online and Museum Resources</h1>
            <p className="text-center text-gray-700 dark:text-gray-300 mb-4">
              - **Victoria and Albert Museum (V&A)**: Their online archives have rich collections of Regency-era menswear, showcasing tailoring and materials.
              <br />
              - **Regency Fashion Blogs**: Websites like &quot;The Fashion Historian&quot; or &quot;Historical Emporium&quot; offer articles and visual guides on Regency clothing for men.
            </p>
          </div>
        </div>
